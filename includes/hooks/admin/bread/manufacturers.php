<?php
    ...
    class hook_admin_bread_manufacturers
    {
        ...
        {
            if (isset($_GET['id'])) $manufacturers_id = tep_db_prepare_input($_GET['id']);
            ...
            $this->setImage($manufacturers_id);           
            $this->setDescription($manufacturers_id);
        }
        ...
        public function listen_DeleteManufacturers()
        {
            ...
            $manufacturers_id = tep_db_prepare_input($_POST['id']);
        ...
        public function setImage($manufacturers_id)
        {
        ...
        public function setDescription($manufacturers_id)
        {
            global $action;
